...
const page = async () => {
  ...
  const filteredProducts = products.filter(product => tubs.some(tub => product.type === tub.name));

  return (
    <>
    <section className="px-4 py-6 mt-6">
        <h1 className="text-3xl text-center font-bold font-playfair mb-2">All Tubs</h1>
        ...
        <div key={product._id} className="rounded-xl mb-6">
          ...
          <div className="p-6 bg-white">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href={`${product.type === 'Hot Tub' ? '/hot-tub' : '/cold-plunge'}/${product._id}`}>
                <div
